...
For instance specific leaf area (SLA) responds negatively to drought and positively to nutrient availability [@devries12; @reich14]. Similarly, the loss of functional trait diversity can occur where niche space is constricted, e.g. due to grazing, mowing or fertilization (Harpole et al 2012, REF Exploratories). 
...
Such associations also extend belowground where fast turnover bacterial dominated microbial communities are associated with plant communities dominated by exploitative species and slow, fungal dominated communities with conservative plants [@devries12; @wardle02]. <!-- @chagnon13 -->. 
