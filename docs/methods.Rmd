...
This documentation is hosted on Github, and should be updated if issues are resolved. 

The code is available on GitHub. 

Data available via BExIS (registration required) under the given IDs or as data files in our shared Dropbox-folder.
