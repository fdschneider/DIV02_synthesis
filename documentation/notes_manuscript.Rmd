...
The proposed framework ordinates community traits found in temperate Grasslands in Germany but should apply to similar ecosystems across Europe. A Globalization of the framework is possible, by assessing the relative abundance of species across multiple functional groups for a wider variety of ecosystem types and combine these date with global trait databases.
